...
{
    internal class ReginaldDiamond : Craftable
    {
        public static TechType thisTechType;
        public static Sprite sprite = GetSprite("DTDiamond");

        public ReginaldDiamond() : base("DTDiamond", "Diamond Extraction", "Diamonds extracted from a Reginald. Added by Metal From Fish.")
        {
            OnFinishedPatching += () =>
            {
        ...
        protected override TechData GetBlueprintRecipe()
        {
            ...
            // Add the appropriate number of TechType.Diamond entries to the linkedItems list
            for (int i = 0; i < outputCount; i++)
            {
                linkedItems.Add(TechType.Diamond);
            }
        ...
        {
            new Ingredient(TechType.Reginald, MetalFromFish_SNHelpers.Config.RCost)
        },
        ...
        {
            var task = CraftData.GetPrefabForTechTypeAsync(TechType.Diamond);
            yield return task;
