...
{
    internal class BoomerangQuartz : Craftable
    {
        public static TechType thisTechType;
        public static Sprite sprite = GetSprite("DTQuartz");

        public BoomerangQuartz() : base("DTQuartz", "Quartz Extraction", "Quartz extracted from a Boomerang. Added by Metal From Fish.")
        {
            OnFinishedPatching += () =>
            {
        ...
        protected override TechData GetBlueprintRecipe()
        {
            ...
            // Add the appropriate number of TechType.Quartz entries to the linkedItems list
            for (int i = 0; i < outputCount; i++)
            {
                linkedItems.Add(TechType.Quartz);
            }
        ...
        {
            new Ingredient(TechType.Boomerang, MetalFromFish_SNHelpers.Config.RCost)
        },
