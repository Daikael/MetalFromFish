...
{
    internal class OculusLithium : Craftable
    {
        public static TechType thisTechType;
        public static Sprite sprite = GetSprite("DTLithium");

        public OculusLithium() : base("DTLithium", "Lithium Extraction", "Lithium extracted from an Oculus. Added by Metal From Fish.")
        {
            OnFinishedPatching += () =>
            {
