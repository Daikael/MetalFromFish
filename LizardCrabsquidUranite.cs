...
{
    internal class LizardCrabsnakeUranite : Craftable
    {
        public static TechType thisTechType;
        public static Sprite sprite = GetSprite("DTUranite");

        public LizardCrabsnakeUranite() : base("DTUranite", "Uranite Extraction", "Traces of urnaite extracted from a Crabsquid and Lava Lizards.")
        {
            OnFinishedPatching += () =>
            {
                LizardCrabsnakeUranite.thisTechType = base.TechType;
            };
        }
        ...
        protected override TechData GetBlueprintRecipe()
        {
            ...
            // Add the appropriate number of TechType.UraniniteCrystal entries to the linkedItems list
            for (int i = 0; i < outputCount; i++)
            {
                linkedItems.Add(TechType.UraniniteCrystal);
            }
        ...
        {
            new Ingredient(TechType.LavaLizard, MetalFromFish_SNHelpers.Config.RCost),
            new Ingredient(TechType.CrabSquid, MetalFromFish_SNHelpers.Config.RCost)
        },
        ...
        {
            var task = CraftData.GetPrefabForTechTypeAsync(TechType.UraniniteCrystal);
            yield return task;
