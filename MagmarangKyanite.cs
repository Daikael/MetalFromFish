...
{
    internal class MagmarangKyanite : Craftable
    {
        public static TechType thisTechType;
        public static Sprite sprite = GetSprite("DTKyanite");

        public MagmarangKyanite() : base("DTKyanite", "Kyanite Extraction", "Kyanite extracted from a Magmarang.")
        {
            OnFinishedPatching += () =>
            {
                MagmarangKyanite.thisTechType = base.TechType;
            };
        }
        ...
        protected override TechData GetBlueprintRecipe()
        {
            ...
            // Add the appropriate number of TechType.Kyanite entries to the linkedItems list
            for (int i = 0; i < outputCount; i++)
            {
                linkedItems.Add(TechType.Kyanite);
            }
        ...
        {
            new Ingredient(TechType.LavaBoomerang, MetalFromFish_SNHelpers.Config.RCost)
        },
