...
namespace MetalFromFish
{
    internal class PeeperTitanium : Craftable
    {
        ...
        protected override TechData GetBlueprintRecipe()
        {
            ...
            // Add the appropriate number of TechType.Titanium entries to the linkedItems list
            for (int i = 0; i < outputCount; i++)
            {
                linkedItems.Add(TechType.Titanium);
            }
        ...
        {
            new Ingredient(TechType.Peeper, MetalFromFish_SNHelpers.Config.RCost)
        },
