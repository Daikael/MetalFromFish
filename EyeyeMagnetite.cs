...
namespace MetalFromFish
{
    internal class EyeyeMagnetite : Craftable
    {
        ...
        protected override TechData GetBlueprintRecipe()
        {
            ...
            // Add the appropriate number of TechType.Magnetite entries to the linkedItems list
            for (int i = 0; i < outputCount; i++)
            {
                linkedItems.Add(TechType.Magnetite);
            }
        ...
        {
            new Ingredient(TechType.Eyeye, MetalFromFish_SNHelpers.Config.RCost)
        },
